...
public class ResponsableJpaDao extends AbstracJpaDao<Long, ResponsableAlumno> {
	...
	List<ResponsableAlumno> findResponsablePatron(String patron) {
	...
	List<Alumno> findRelacionAlumnos(Long id) {
		String queryString = "SELECT o From ALUMNO Where responsable='"+ id +"';";
