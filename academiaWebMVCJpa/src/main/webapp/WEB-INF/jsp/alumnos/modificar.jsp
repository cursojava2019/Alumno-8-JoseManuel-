                                ...
                                <div class="col-lg-6">
                                	<form:form action="./modificar.html" method="post" modelAttribute="formulario" >
										...
										<div class="form-group">
											...
											<form:select path="responsableAlumno" 
	      											cssClass="form-control" >
	      										 <form:option value="${formulario.responsableAlumno.id}" label="${formulario.responsableAlumno.nombre}" />
	         								 	 <form:options var="responsable" items="${responsables}" itemValue="id" itemLabel="nombre" /> 	  
	     									</form:select>
                                        </div>
                                        <div class="form-group">
                                            <div class="checkbox">
